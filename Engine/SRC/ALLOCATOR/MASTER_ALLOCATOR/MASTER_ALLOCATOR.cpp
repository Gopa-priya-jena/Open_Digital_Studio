...
MASTER_ALLOCATOR::MASTER_ALLOCATOR()
{
  ...
  per_thread_cache = complete_info.cpu_info.L3_mem_total / complete_info.cpu_info.cores;

  LOG( per_thread_cache );
  per_thread_cache *= 20;
  U16 total_allocations = complete_info.cpu_info.cores * complete_info.cpu_info.thread_per_core;
