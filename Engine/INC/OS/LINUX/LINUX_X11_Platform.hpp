  ...
  namespace WINDOW
  {
    ...
    struct Window_X11
    {
      ...
      // The last received cursor position, regardless of source
       I32 lastCursorPosX, lastCursorPosY;
      // The last position the cursor was warped to by GLFW
       I32 warpCursorPosX, warpCursorPosY;
    ...
    public:
      ...
      // System content scale
       F32 contentScaleX{}, contentScaleY{};
      ...
      // short  I32 keycodes[256];
      // GLFW key to X11 keycode LUT
      // short  I32 scancodes[GLFW_KEY_LAST + 1];
      // Where to place the cursor when re-enabled
       F64   restoreCursorPosX{}, restoreCursorPosY{};
      ...
      bool          Terminate_Window();
       I32   GetWindowPropertyX11( Window window, Atom property,
                                          Atom type, unsigned char **value );
      void          GrabErrorHandlerX11( void );
      void          ReleaseErrorHandlerX11( void );
      Atom getAtomIfSupported( Atom *supportedAtoms,  I32   atomCount,
                               const char *atomName );
    };
